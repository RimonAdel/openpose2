...
class CmuModel(tf.keras.Model):
    ...
    def __init__(self, masked_outputs=True):
        ...
        self.stage1_conv5_l = conv2d(keypoints_num, 1, "conv_stage1_10", activation=None)
        ...
        self.stage2_conv7_l = conv2d(keypoints_num, 1, "conv_stage2_14", activation=None)
        ...
        self.stage3_conv7_l = conv2d(keypoints_num, 1, "conv_stage3_14", activation=None)
        ...
        self.stage4_conv7_l = conv2d(keypoints_num, 1, "conv_stage4_14", activation=None)
        ...
        self.stage5_conv7_l = conv2d(keypoints_num, 1, "conv_stage5_14", activation=None)
        ...
        self.stage6_conv7_l = conv2d(keypoints_num, 1, "conv_stage6_14", activation=None)
    ...
    def call(self, inputs):
        ...
        if self.masked_outputs and inputs_with_masks:
            output_1_s = self.masked_1_s([s_1,in puts[1]])
